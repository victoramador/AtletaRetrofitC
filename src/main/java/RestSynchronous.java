...
public class RestSynchronous {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Call<List<Atleta>> call2 = atletaService.getAtletasByNacionalidad("China");
        ...
        atleta.setNombre("Victor"); atleta.setApellidos("Amador");
        ...
        if (responseAtleta.isSuccessful()) {
            ...
            System.out.println("Status code: "+responseAtleta.code()+System.lineSeparator()+"POST player: "+atletaResp);
            callAtleta = atletaService.updateAtleta(atletaResp);
            responseAtleta= callAtleta.execute();

            System.out.println("Status code: "+responseAtleta.code()+System.lineSeparator()+"PUT player: "+responseAtleta.body());
            ...
            System.out.println("Comprobación del delete Status code: " +response.code()+System.lineSeparator()+"GET players: "+response.body());
        } else {
            System.out.println("Status code: "+responseAtleta.code()+"Message error: "+responseAtleta.errorBody());
        }
    }
}